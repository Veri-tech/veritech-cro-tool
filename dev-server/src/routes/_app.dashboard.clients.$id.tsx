      ...
      <section>
        ...
        <div className="vt-card overflow-x-auto">
          <table className="w-full text-sm min-w-[820px]">
            ...
            <tbody>
              {audits.length === 0 && <tr><td colSpan={7} className="p-8 text-center text-[color:var(--muted)]">No audits yet.</td></tr>}
              {audits.map((a: any) => (
                <tr key={a.id} className="border-t border-[color:var(--border)] hover:bg-[color:var(--navy)]/60">
                  ...
                  <td className="px-4 py-3 text-right space-x-2">
                    ...
                    <button
                      ...
                      onClick={() => { navigator.clipboard.writeText(a.page_url); toast.success("Link copied"); }}
                    >
                      Copy URL
                    </button>
                  </td>
